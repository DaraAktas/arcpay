...
{
    private static readonly (string CustomerNumber, decimal Balance, Guid Reference)[] DemoWallets =
    [
        ("ARC-9000000001", 1000m, Guid.Parse("90000001-0000-0000-0000-000000000001")),
        ("ARC-9000000002", 250m, Guid.Parse("90000002-0000-0000-0000-000000000002")),
        ("ARC-9000000003", 0m, Guid.Parse("90000003-0000-0000-0000-000000000003"))
    ];
